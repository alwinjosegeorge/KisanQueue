...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "SmartProcure — Farmer Procurement Queue" },
      {
        name: "description",
        content:
          "Book procurement slots, follow your queue, and track crop procurement and payments with SmartProcure.",
      },
      { property: "og:title", content: "SmartProcure — Procure Smarter. Wait Less." },
      {
    ...
    <main className="splash-screen">
      ...
      <div className="relative z-10 flex min-h-dvh flex-col px-6 pb-7 pt-10 sm:mx-auto sm:max-w-md">
        ...
        <div className="mt-auto">
          ...
          <h1 className="mt-2 font-display text-6xl leading-[0.92] text-primary-foreground">Smart<br />Procure</h1>
      ...
      <section className="relative mx-auto flex min-h-[calc(100dvh-2rem)] w-full max-w-md flex-col overflow-hidden rounded-[2rem] bg-primary p-5 text-primary-foreground shadow-float sm:min-h-[780px]">
        ...
        <div className="mt-auto pt-8">
          ...
          <div className="mt-8 grid grid-cols-[1fr_auto] items-center gap-4">
            ...
            <AppButton tone="soft" onClick={onNext}>{step === 2 ? "Open SmartProcure" : "Next"}<ChevronRight className="size-4" /></AppButton>
          </div>
        </div>
      </section>
    </main>
